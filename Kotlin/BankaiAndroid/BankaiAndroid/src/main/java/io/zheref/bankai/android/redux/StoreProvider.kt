...
import io.zheref.bankai.udf.redux.Store
import io.zheref.bankai.udf.redux.TypedStore
...
public fun <State> rememberStore(): Store<State> {
    return LocalStore.current as Store<State>
}
